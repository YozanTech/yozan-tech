...
export default async function AboutPage() {
  ...
  return (
    <div className="flex flex-col flex-1">
      <section className="flex flex-col md:flex-row w-full items-center justify-center px-4 py-8 md:p-24! gap-12 md:gap-24 border-b border-surface-200/80">
        <div className="flex flex-col gap-2 w-full">
          ...
          <FadeIn delay={0.4} initialX={-20}>
            <h1 className="font-bold text-2xl text-left md:text-5xl flex flex-col md:gap-2 text-surface-900">
              ...
              <span className="max-w-4xl"> {t("heroTitle2")}</span>
            </h1>
          </FadeIn>
          <FadeIn
            delay={0.6}
      ...
      <section className="flex flex-col md:flex-row w-full items-center bg-surface-50 justify-center px-4 py-8 md:p-24 gap-8 md:gap-16 border-b border-surface-200/80">
        <div className="flex-1 flex flex-col w-full gap-2 h-full">
          ...
          <FadeIn
            delay={0.4}
            initialX={-20}
            className="text-2xl md:text-4xl text-surface-900 font-bold"
          >
            {t("storyTitle")}
          </FadeIn>
        </div>
      ...
      <section className="flex flex-col w-full items-center justify-center px-4 py-8 md:p-24! gap-8 md:gap-16 border-b border-surface-200/80">
        <div className="flex flex-col gap-2 w-full">
          <FadeIn
            delay={0.2}
            initialX={-20}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 w-full mt-4 md:mt-0">
          {PRINCIPLE.map((principle, index) => (
            ...
            >
              <span className="text-4xl md:text-5xl font-bold text-brand-200">
                0{index + 1}
              </span>
              <span className="text-surface-900 font-bold text-base md:text-lg">
                {t(`principles.${principle.id}.title`)}
              </span>
              <span className="text-surface-600 text-xs md:text-sm leading-relaxed">
      ...
      <section className="flex flex-col w-full items-center bg-surface-50 justify-center px-4 py-38 md:p-24 border-b border-surface-200/80">
